  ...
  return (
    <Link to={`/tarif/${recipe.id}`} className="bg-white rounded-lg p-4">
      <div className="relative">
        ...
        />
        <p className="absolute bg-red-400 rounded-lg px-2 py-1 font-semibold flex items-center gap-2 bottom-1 left-1">
          <TbClockHour8 />
          <span className="">{recipe.recipeTime} dakika</span>
        </p>
      </div>
